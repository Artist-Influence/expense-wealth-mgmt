...
export const SYMBOL_PRESETS: Array<{ value: string; label: string; basket?: string }> = [
  ...
  { value: 'SMH', label: 'Semiconductors (SMH)' },
  { value: 'XLU', label: 'Utilities (XLU)' },
  { value: 'ARKX', label: 'Space (ARKX)' },
  { value: 'BTC-USD', label: 'Bitcoin (BTC)' },
  { value: 'ETH-USD', label: 'Ethereum (ETH)' },
  { value: 'SOL-USD', label: 'Solana (SOL)' },
  { value: 'XRP-USD', label: 'XRP' },
  { value: 'basket:BTC-USD:0.40,XRP-USD:0.36,ETH-USD:0.12,SOL-USD:0.12', label: 'Gemini basket (your mix)' },
  { value: 'basket:SMH:0.55,QQQ:0.32,XLU:0.08,ARKX:0.05', label: 'Dub basket (your mix)' },
